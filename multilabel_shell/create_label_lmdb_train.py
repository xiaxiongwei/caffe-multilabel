...
output_lmdb_path = '../data/coco/label_lmdb/train/'   	# Path of the output label LMDB
labels_mat_file = '../../train_{}.mat'							# Mat file for labels N x M 
# +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
for i in [1,2,3,4,5]:
	print 'load matfile {}'.format(i)
	mat_contents = scipy.io.loadmat(labels_mat_file.format(i))

	X[(i-1)*100000:i*100000,:,0,0] = mat_contents['label'] 	
